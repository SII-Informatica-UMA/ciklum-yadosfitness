...
const dietasC: Dieta [] = [
  {
    nombre: 'Definicion',
    descripcion: 'Perdida de grasa',
    observaciones: 'bajar 0,5 kg a la semana',
    objetivo: 'Disminuir % graso',
    duracionDias: 60,
    alimentos: ['Arroz', 'Pollo', 'Aguacate'],
    recomendaciones: 'usar poco aceite al cocinar',
    id: 1,
    usuarioId: 4,
    creadorId: 2
  },
